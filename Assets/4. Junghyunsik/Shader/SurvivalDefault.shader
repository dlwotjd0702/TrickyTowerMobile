Shader "UI/VerticalThreeColorGradient"
{
    Properties
    {
        ...
        _TopColor    ("Top Color",    Color) = (0.098, 0.000, 0.302, 1)  // 첫번째 이미지
        _MiddleColor ("Middle Color", Color) = (0.357, 0.165, 0.706, 1)   // 두번째 이미지
        _BottomColor ("Bottom Color", Color) = (0.255, 0.000, 0.698, 1)  // 세번째 이미지
    }
    SubShader
    {
        Tags
