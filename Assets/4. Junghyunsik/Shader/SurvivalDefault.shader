Shader "Custom/VerticalThreeColorGradient_Local"
{
    Properties
    {
        _TopColor    ("Top Color",    Color) = (0.988, 0.631, 0.420, 1)  // 첫번째 이미지
        _MiddleColor ("Middle Color", Color) = (0.992, 0.973, 0.757, 1)  // 두번째 이미지
        _BottomColor ("Bottom Color", Color) = (0.988, 0.631, 0.420, 1)  // 세번째 이미지
    }
    SubShader
    {
